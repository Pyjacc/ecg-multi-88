...
from steps.normal.feature_normal import GetFeature      # todo,不同的模型对应不同的GetFeature
...
def train_lgb_model():
    model_1d_path = args.model_path_normal_1d          # todo: 需要修改的变量
    model_2d_path = args.model_path_normal_2d
    feature_path = args.feature_renet_normal_csv
...
def search_optimal_parameters(train_data, train_lable):
    ...
    params = {'estimator__max_depth': [2, 3, 4],
              'estimator__num_leaves': [4, 5],
              'estimator__n_estimators': [40, 50],
