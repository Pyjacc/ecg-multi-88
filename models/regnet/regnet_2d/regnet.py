...
# https://github.com/JiawangBian/regnet.pytorch
...
class BasicBlock1d(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 group_width=1, dilation=1, norm_layer=None):
...
class BasicBlock2dA(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=(1, 1), downsample=None,
                 group_width=1, dilation=1, norm_layer=None):
        super(BasicBlock2dA, self).__init__()
...
class RegNet(nn.Module):
    def __init__(self, block, layers, widths, num_classes=12, input_channels=12, zero_init_residual=True,
        ...
        self.conv1 = nn.Conv2d(input_channels, self.inplanes, kernel_size=3, stride=2, padding=1,
                               bias=False)
    ...
    def forward(self, x):
        loss_kl = 0.00001
        return self._forward_impl(x), loss_kl
...
# use BasicBlock2dA
def regnetx_008(**kwargs):
    return RegNet(BasicBlock2dA, [1, 3, 7, 5], [64, 128, 288, 672], group_width=16, **kwargs)
...
def regnetx_032(**kwargs):
    logger.info("using regnetx_032 and basic block 2da")
    return RegNet(BasicBlock2dA, [2, 6, 15, 2], [96, 192, 432, 1008], group_width=48, **kwargs)
