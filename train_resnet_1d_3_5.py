...
'''训练resnet模型，使用1维的卷积核，卷积核的大小为3*3和5*5'''

import os
import torch
from torch.utils.data import DataLoader
from models.resnet.resnet34_rdrop import resnet341d3_5     # todo
...
def train_model():
    ...
    network = resnet341d3_5(input_channels=num_leads, num_classes=num_class).to(device)  # todo: 选择不同的模型
